...
android {
    ...
    packaging {
        jniLibs.pickFirsts.add("lib/x86/libaosl.so")
        jniLibs.pickFirsts.add("lib/x86_64/libaosl.so")
        jniLibs.pickFirsts.add("lib/armeabi-v7a/libaosl.so")
        jniLibs.pickFirsts.add("lib/arm64-v8a/libaosl.so")
    }
