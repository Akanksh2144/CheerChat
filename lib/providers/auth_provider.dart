...
/// Tracks whether a logout is in progress.
/// AuthGate checks this BEFORE the fbUser == null check so the transition
/// goes AppShell → SplashScreen → LoginPage, never directly AppShell → LoginPage.
final isLoggingOutProvider =
    NotifierProvider<_LoggingOutNotifier, bool>(
      _LoggingOutNotifier.new,
    );

class _LoggingOutNotifier extends Notifier<bool> {
  @override
  bool build() => false;
